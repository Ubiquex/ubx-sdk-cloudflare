...
class RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfo_Address:
    city: Any = None
...
@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfo:
    address: Any = None
    name: Any = None
    organization: Any = None

@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator:
    email: Any = None
    fax: Any = None
    phone: Any = None
...
@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Contacts:
...
@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Errors_Source:
    pointer: Any = None

@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Errors:
    code: Any = None
    message: Any = None
    source: Any = None

@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingle_Result:
...
_RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfo_AddressFields = {
...
_RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfoFields = {
    "address": ubx.FieldSpec(
        wire_name="address",
        kind="object",
        fields=_RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfo_AddressFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "organization": ubx.FieldSpec(wire_name="organization"),
}

_RegistrarApiSandboxRegistrationResponseSingle_Contacts_AdministratorFields = {
    ...
    "postal_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RegistrarApiSandboxRegistrationResponseSingle_Contacts_Administrator_PostalInfoFields,
    ),
}

_RegistrarApiSandboxRegistrationResponseSingle_ContactsFields = {
    "administrator": ubx.FieldSpec(
        wire_name="administrator",
        kind="object",
        fields=_RegistrarApiSandboxRegistrationResponseSingle_Contacts_AdministratorFields,
    ),
...
@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingleConfig:
...
@dataclasses.dataclass
class RegistrarApiSandboxRegistrationResponseSingleAttrs:
    # Provides user acknowledgements for a specific extension or premium registration flow. The extension registration schema from the extension discovery endpoint identifies the required keys.
    acknowledgements: Any = None
    # Enable or disable automatic renewal. Defaults to `false` if omitted. Setting this field to `true` is an explicit opt-in authorizing Cloudflare to charge the account's default payment method up to 30 days before domain expiry to renew the domain automatically. Renewal pricing may change over time based on registry pricing.
    auto_renew: Any = None
...
RegistrarApiSandboxRegistrationResponseSingle = ubx.ResourceBinding(
    wire_type="cloudflare_registrar_api_sandbox_registration_response_single",
    fields={
        ...
        "contacts": ubx.FieldSpec(
            wire_name="contacts",
            kind="object",
            fields=_RegistrarApiSandboxRegistrationResponseSingle_ContactsFields,
        ),
