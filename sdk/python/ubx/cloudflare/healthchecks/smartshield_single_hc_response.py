...
class SmartshieldSingleHcResponse_HttpConfig:
...
@dataclasses.dataclass
class SmartshieldSingleHcResponseConfig:
    # The hostname or IP address of the origin server to run health checks on.
    address: Any = None
    # A list of regions from which to run health checks. Null means Cloudflare will pick a default region.
    check_regions: Any = None
...
@dataclasses.dataclass
class SmartshieldSingleHcResponseAttrs:
    # The hostname or IP address of the origin server to run health checks on.
    address: Any = None
    # A list of regions from which to run health checks. Null means Cloudflare will pick a default region.
    check_regions: Any = None
...
SmartshieldSingleHcResponse = ubx.ResourceBinding(
    wire_type="cloudflare_smartshield_single_hc_response",
    fields={
        ...
        "http_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SmartshieldSingleHcResponse_HttpConfigFields,
        ),
