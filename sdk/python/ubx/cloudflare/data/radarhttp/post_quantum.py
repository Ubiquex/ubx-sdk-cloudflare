...
class PostQuantum_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class PostQuantum_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class PostQuantum_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class PostQuantum_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class PostQuantum_Result_Meta:
...
@dataclasses.dataclass
class PostQuantum_Result_Summary0:
    # A numeric string.
    not_supported: Any = None
    # A numeric string.
    supported: Any = None

@dataclasses.dataclass
class PostQuantum_Result:
...
PostQuantum = ubx.DataSourceBinding(
    wire_type="cloudflare_post_quantum",
    fields={
        "asn": ubx.FieldSpec(wire_name="asn"),
        "bot_class": ubx.FieldSpec(wire_name="bot_class"),
        "browser_family": ubx.FieldSpec(wire_name="browser_family"),
