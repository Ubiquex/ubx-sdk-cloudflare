...
class Task_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class Task_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class Task_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class Task_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Task_Result_Meta:
