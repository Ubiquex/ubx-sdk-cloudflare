...
class MatchingAnswer_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class MatchingAnswer_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class MatchingAnswer_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class MatchingAnswer_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class MatchingAnswer_Result_Meta:
...
@dataclasses.dataclass
class MatchingAnswer_Result_Summary0:
    # A numeric string.
    negative: Any = None
    # A numeric string.
    positive: Any = None
...
@dataclasses.dataclass
class MatchingAnswer_Result:
    # Metadata for the results.
    meta: Any = None
    summary_0: Any = None

@dataclasses.dataclass
class MatchingAnswerConfig:
...
MatchingAnswer = ubx.DataSourceBinding(
    wire_type="cloudflare_matching_answer",
    fields={
