...
class ManagedRule_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class ManagedRule_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class ManagedRule_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class ManagedRule_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class ManagedRule_Result_Meta:
...
@dataclasses.dataclass
class ManagedRule_Result:
    # Metadata for the results.
    meta: Any = None
    summary_0: Any = None

@dataclasses.dataclass
class ManagedRuleConfig:
    ...
    mitigation_product: Any = None
    # Array of names used to label the series in the response.
    name: Any = None

@dataclasses.dataclass
class ManagedRuleAttrs:
    # Filters results by Autonomous System. Specify one or more Autonomous System Numbers (ASNs) as a comma-separated list. Prefix with `-` to exclude ASNs from results. For example, `-174, 3356` excludes results from AS174, but includes results from AS3356.
    asn: Any = None
    # Filters results by continent. Specify a comma-separated list of alpha-2 codes. Prefix with `-` to exclude continents from results. For example, `-EU,NA` excludes results from EU, but includes results from NA.
    continent: Any = None
...
ManagedRule = ubx.DataSourceBinding(
    wire_type="cloudflare_managed_rule",
    fields={
        ...
        "mitigation_product": ubx.FieldSpec(wire_name="mitigation_product"),
