...
class Annotation_Result_Annotations_AsnsDetails_Locations:
    code: Any = None
    name: Any = None

@dataclasses.dataclass
class Annotation_Result_Annotations_AsnsDetails:
    asn: Any = None
    locations: Any = None
    name: Any = None

@dataclasses.dataclass
class Annotation_Result_Annotations_OriginsDetails:
    name: Any = None
    origin: Any = None

@dataclasses.dataclass
class Annotation_Result_Annotations_Outage:
    outage_cause: Any = None
    outage_type: Any = None

@dataclasses.dataclass
class Annotation_Result_Annotations:
    asns: Any = None
...
Annotation = ubx.DataSourceBinding(
    wire_type="cloudflare_annotation",
    fields={
