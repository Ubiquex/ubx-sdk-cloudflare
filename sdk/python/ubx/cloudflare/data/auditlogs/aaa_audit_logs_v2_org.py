...
class AaaAuditLogsV2Org_Errors:
    message: Any = None

@dataclasses.dataclass
class AaaAuditLogsV2Org_Result_Action:
...
@dataclasses.dataclass
class AaaAuditLogsV2Org_Result_Actor:
    context: Any = None
    email: Any = None
    id: Any = None
    ip_address: Any = None
...
@dataclasses.dataclass
class AaaAuditLogsV2Org_Result_Organization:
    id: Any = None

@dataclasses.dataclass
class AaaAuditLogsV2Org_Result_Raw:
    cf_ray_id: Any = None
    method: Any = None
...
@dataclasses.dataclass
class AaaAuditLogsV2Org_Result_Resource:
    id: Any = None
    product: Any = None
    request: Any = None
    response: Any = None
...
@dataclasses.dataclass
class AaaAuditLogsV2Org_Result:
    action: Any = None
    actor: Any = None
    id: Any = None
...
@dataclasses.dataclass
class AaaAuditLogsV2Org_ResultInfo:
...
AaaAuditLogsV2Org = ubx.DataSourceBinding(
    wire_type="cloudflare_aaa_audit_logs_v2_org",
    fields={
