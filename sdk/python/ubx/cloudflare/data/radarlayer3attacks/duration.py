...
class Duration_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class Duration_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class Duration_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class Duration_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Duration_Result_Meta:
...
@dataclasses.dataclass
class Duration_Result_Summary0:
    # A numeric string.
    over_3_hours: Any = None
    # A numeric string.
    under_10_mins: Any = None

@dataclasses.dataclass
class Duration_Result:
...
Duration = ubx.DataSourceBinding(
    wire_type="cloudflare_duration",
    fields={
