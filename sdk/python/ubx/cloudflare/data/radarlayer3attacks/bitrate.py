...
class Bitrate_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class Bitrate_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class Bitrate_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class Bitrate_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Bitrate_Result_Meta:
...
@dataclasses.dataclass
class Bitrate_Result_Summary0:
    # A numeric string.
    over_100_gbps: Any = None
    # A numeric string.
    under_500_mbps: Any = None

@dataclasses.dataclass
class Bitrate_Result:
...
Bitrate = ubx.DataSourceBinding(
    wire_type="cloudflare_bitrate",
    fields={
