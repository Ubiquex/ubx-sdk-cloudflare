...
class Attack_Result_Meta_ConfidenceInfo_Annotations:
...
@dataclasses.dataclass
class Attack_Result_Meta_ConfidenceInfo:
    annotations: Any = None
    # Provides an indication of how much confidence Cloudflare has in the data.
    level: Any = None

@dataclasses.dataclass
class Attack_Result_Meta_DateRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class Attack_Result_Meta_Units:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Attack_Result_Meta:
...
@dataclasses.dataclass
class Attack_Result_Top0:
    origin_country_alpha2: Any = None
    origin_country_name: Any = None
    value: Any = None
...
Attack = ubx.DataSourceBinding(
    ...
    fields={
        ...
        "limit_direction": ubx.FieldSpec(wire_name="limit_direction"),
        "limit_per_location": ubx.FieldSpec(wire_name="limit_per_location"),
