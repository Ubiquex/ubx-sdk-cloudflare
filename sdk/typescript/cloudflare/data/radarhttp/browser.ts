// Code generated by `ubx sdk gen` from cloudflare_browser. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface Browser_Result_Meta_ConfidenceInfo_Annotations {
...
export interface Browser_Result_Meta_ConfidenceInfo {
  annotations: Browser_Result_Meta_ConfidenceInfo_Annotations[] | Computed<Browser_Result_Meta_ConfidenceInfo_Annotations[]>;
  /** Provides an indication of how much confidence Cloudflare has in the data. */
  level: number | Computed<number>;
}

export interface Browser_Result_Meta_DateRange {
  endTime?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface Browser_Result_Meta_Units {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface Browser_Result_Meta {
  /** Aggregation interval of the results (e.g., in 15 minutes or 1 hour intervals). Refer to [Aggregation intervals](https://developers.cloudflare.com/radar/concepts/aggregation-intervals/). */
  aggInterval: string | Computed<string>;
  confidenceInfo: Browser_Result_Meta_ConfidenceInfo | Computed<Browser_Result_Meta_ConfidenceInfo>;
  dateRange: Browser_Result_Meta_DateRange[] | Computed<Browser_Result_Meta_DateRange[]>;
  /** Timestamp of the last dataset update. */
  lastUpdated: string | Computed<string>;
  /** Normalization method applied to the results. Refer to [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/). */
  normalization: string | Computed<string>;
  /** Measurement units for the results. */
  units: Browser_Result_Meta_Units[] | Computed<Browser_Result_Meta_Units[]>;
}

export interface Browser_Result_Serie0 {
  timestamps: string[] | Computed<string[]>;
}

export interface Browser_Result {
  /** Metadata for the results. */
  meta: Browser_Result_Meta | Computed<Browser_Result_Meta>;
  serie0: Browser_Result_Serie0 | Computed<Browser_Result_Serie0>;
}
...
export const Browser: DataSourceBinding<BrowserConfig, BrowserAttrs> = {
  wireType: "cloudflare_browser",
  fields: {
