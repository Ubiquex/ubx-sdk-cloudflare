...
export interface FirewallResponseCollection_Result_Configuration {
  target?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface FirewallResponseCollection_Result_Scope {
  email?: string | Computed<string>;
  id?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface FirewallResponseCollection_Result {
  allowedModes?: string[] | Computed<string[]>;
  configuration?: FirewallResponseCollection_Result_Configuration | Computed<FirewallResponseCollection_Result_Configuration>;
  createdOn?: string | Computed<string>;
  id?: string | Computed<string>;
  mode?: string | Computed<string>;
  modifiedOn?: string | Computed<string>;
  notes?: string | Computed<string>;
  scope?: FirewallResponseCollection_Result_Scope | Computed<FirewallResponseCollection_Result_Scope>;
}
...
export interface FirewallResponseCollectionAttrs {
  ...
  /** Defines the maximum number of results requested. */
  perPage: number;
  result: FirewallResponseCollection_Result[];
}
