...
export interface AccessSingleResponse2_Result_CreatedAt {
}

export interface AccessSingleResponse2_Result {
  /** The Client ID for the service token. Access will check for this value in the `CF-Access-Client-ID` request header. */
  clientId?: string | Computed<string>;
  createdAt?: AccessSingleResponse2_Result_CreatedAt | Computed<AccessSingleResponse2_Result_CreatedAt>;
  ...
  id?: AccessSingleResponse2_Result_CreatedAt | Computed<AccessSingleResponse2_Result_CreatedAt>;
  lastSeenAt?: AccessSingleResponse2_Result_CreatedAt | Computed<AccessSingleResponse2_Result_CreatedAt>;
  /** The name of the service token. */
  name?: string | Computed<string>;
  updatedAt?: AccessSingleResponse2_Result_CreatedAt | Computed<AccessSingleResponse2_Result_CreatedAt>;
}

export interface AccessSingleResponse2Config {
...
export interface AccessSingleResponse2Attrs {
  /** A version number identifying the current `client_secret` associated with the service token. Incrementing it triggers a rotation; the previous secret will still be accepted until the time indicated by `previous_client_secret_expires_at`. */
  ...
  result: AccessSingleResponse2_Result;
  /** path parameter, not part of the API's own resource representation */
  accountId: string;
  /** path parameter, not part of the API's own resource representation */
...
export const AccessSingleResponse2: ResourceBinding<AccessSingleResponse2Config, AccessSingleResponse2Attrs> = {
