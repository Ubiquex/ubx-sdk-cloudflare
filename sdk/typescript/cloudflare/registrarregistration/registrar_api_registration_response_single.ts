...
export interface RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo_Address {
...
export interface RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo {
  address?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo_Address | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo_Address>;
  name?: string | Computed<string>;
  organization?: string | Computed<string>;
}

export interface RegistrarApiRegistrationResponseSingle_Contacts_Administrator {
  email?: string | Computed<string>;
  fax?: string | Computed<string>;
  phone?: string | Computed<string>;
  postalInfo?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo>;
}

export interface RegistrarApiRegistrationResponseSingle_Contacts {
  ...
  administrator?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator>;
  ...
  billing?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator>;
  /** Optional registrant contact. If omitted, the account's default address book entry is used instead. */
  registrant?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator>;
  ...
  technical?: RegistrarApiRegistrationResponseSingle_Contacts_Administrator | Computed<RegistrarApiRegistrationResponseSingle_Contacts_Administrator>;
}

export interface RegistrarApiRegistrationResponseSingle_Errors_Source {
  pointer?: string | Computed<string>;
}

export interface RegistrarApiRegistrationResponseSingle_Errors {
  code?: number | Computed<number>;
  message?: string | Computed<string>;
  source?: RegistrarApiRegistrationResponseSingle_Errors_Source | Computed<RegistrarApiRegistrationResponseSingle_Errors_Source>;
}

export interface RegistrarApiRegistrationResponseSingle_Result {
...
const RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfo_AddressFields: FieldMap = {
  city: "city",
...
const RegistrarApiRegistrationResponseSingle_Contacts_Administrator_PostalInfoFields: FieldMap = {
  address: {
    wireName: "address",
    kind: "object",
...
const RegistrarApiRegistrationResponseSingle_Contacts_AdministratorFields: FieldMap = {
  email: "email",
  fax: "fax",
  phone: "phone",
  postalInfo: {
...
const RegistrarApiRegistrationResponseSingle_ContactsFields: FieldMap = {
  administrator: {
...
export interface RegistrarApiRegistrationResponseSingleConfig {
  ...
  contacts?: RegistrarApiRegistrationResponseSingle_Contacts | Computed<RegistrarApiRegistrationResponseSingle_Contacts>;
  /** Provides a fully qualified domain name (FQDN), including the extension (e.g., `example.com`, `mybrand.app`). The domain name uniquely identifies a registration. Cloudflare permits only one registration per domain, making the domain name a natural idempotency key for registration requests. */
  domainName: string | Computed<string>;
...
export interface RegistrarApiRegistrationResponseSingleAttrs {
  /** Provides user acknowledgements for a specific extension or premium registration flow. The extension registration schema from the extension discovery endpoint identifies the required keys. */
  ...
  result: RegistrarApiRegistrationResponseSingle_Result;
...
export const RegistrarApiRegistrationResponseSingle: ResourceBinding<RegistrarApiRegistrationResponseSingleConfig, RegistrarApiRegistrationResponseSingleAttrs> = {
