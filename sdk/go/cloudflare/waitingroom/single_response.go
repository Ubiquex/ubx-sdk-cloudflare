// Code generated by `ubx sdk gen` from cloudflare_waitingroom_single_response. DO NOT EDIT.
package waitingroom

import ubx "github.com/ubiquex/ubx-sdk-go/runtime"

type SingleResponse_AdditionalRoutes struct {
	Host any
	Path any
}

type SingleResponse_CookieAttributes struct {
...
var SingleResponse_AdditionalRoutesFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
		"Path": ubx.FieldSpec{WireName: "path"},
	}

var SingleResponse_CookieAttributesFields = ubx.FieldMap{
...
var SingleResponse = ubx.ResourceBinding{
	WireType: "cloudflare_waitingroom_single_response",
	Fields: ubx.FieldMap{
		"AdditionalRoutes": ubx.FieldSpec{
			WireName: "additional_routes",
			Kind: "list",
			Fields: SingleResponse_AdditionalRoutesFields,
		},
		"CookieAttributes": ubx.FieldSpec{
			WireName: "cookie_attributes",
			Kind: "object",
			Fields: SingleResponse_CookieAttributesFields,
		},
		"CookieSuffix": ubx.FieldSpec{WireName: "cookie_suffix"},
		"CustomPageHtml": ubx.FieldSpec{WireName: "custom_page_html"},
		"DefaultTemplateLanguage": ubx.FieldSpec{WireName: "default_template_language"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisableSessionRenewal": ubx.FieldSpec{WireName: "disable_session_renewal"},
		"EnabledOriginCommands": ubx.FieldSpec{WireName: "enabled_origin_commands"},
		"Host": ubx.FieldSpec{WireName: "host"},
		"JsonResponseEnabled": ubx.FieldSpec{WireName: "json_response_enabled"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"NewUsersPerMinute": ubx.FieldSpec{WireName: "new_users_per_minute"},
		"Path": ubx.FieldSpec{WireName: "path"},
		"QueueAll": ubx.FieldSpec{WireName: "queue_all"},
		"QueueingMethod": ubx.FieldSpec{WireName: "queueing_method"},
		"QueueingStatusCode": ubx.FieldSpec{WireName: "queueing_status_code"},
