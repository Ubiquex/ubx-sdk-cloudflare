...
package radartrafficanomalies

import ubx "github.com/ubiquex/ubx-sdk-go/runtime"

type TrafficAnomaly_Result_TrafficAnomalies_AsnDetails_Locations struct {
	Code any
	Name any
}
...
type TrafficAnomaly_Result struct {
	TrafficAnomalies any
}
...
type TrafficAnomalyAttrs struct {
	// Filters results by Autonomous System. Specify a single Autonomous System Number (ASN) as integer.
	Asn any
	// End of the date range (inclusive). Alternative to `dateRange`; provide together with `dateStart`.
	DateEnd any
