...
type DnssecE2e_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type DnssecE2e_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type DnssecE2e_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type DnssecE2e_Result_Meta_Units struct {
	Name  any
	Value any
}

type DnssecE2e_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
type DnssecE2e_Result_Summary0 struct {
	// A numeric string.
	Negative any
	// A numeric string.
	Positive any
...
type DnssecE2e_Result struct {
	// Metadata for the results.
	Meta     any
	Summary0 any
}

type DnssecE2eConfig struct {
...
var DnssecE2e = ubx.DataSourceBinding{
