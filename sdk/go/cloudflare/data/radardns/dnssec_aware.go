...
type DnssecAware_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type DnssecAware_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type DnssecAware_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type DnssecAware_Result_Meta_Units struct {
	Name  any
	Value any
}

type DnssecAware_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
type DnssecAware_Result_Summary0 struct {
	// A numeric string.
	NotSupported any
	// A numeric string.
	Supported any
...
type DnssecAware_Result struct {
	// Metadata for the results.
	Meta     any
	Summary0 any
}

type DnssecAwareConfig struct {
...
var DnssecAware = ubx.DataSourceBinding{
