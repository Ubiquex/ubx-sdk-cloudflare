...
type Arc_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type Arc_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type Arc_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type Arc_Result_Meta_Units struct {
	Name  any
	Value any
}

type Arc_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
type Arc_Result_Summary0 struct {
	// A numeric string.
	Fail any
	// A numeric string.
	None any
