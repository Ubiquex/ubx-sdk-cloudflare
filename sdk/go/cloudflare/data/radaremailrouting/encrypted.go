...
type Encrypted_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource any
	Description any
	EndDate any
	EventType any
...
type Encrypted_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type Encrypted_Result_Meta_DateRange struct {
	EndTime any
	StartTime any
}

type Encrypted_Result_Meta_Units struct {
	Name any
	Value any
}

type Encrypted_Result_Meta struct {
	ConfidenceInfo any
	DateRange any
...
type Encrypted_Result_Summary0 struct {
	// A numeric string.
	Encrypted any
	// A numeric string.
	NotEncrypted any
...
var Encrypted = ubx.DataSourceBinding{
