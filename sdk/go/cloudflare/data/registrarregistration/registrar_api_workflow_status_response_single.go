...
type RegistrarApiWorkflowStatusResponseSingle_Errors_Source struct {
	Pointer any
}

type RegistrarApiWorkflowStatusResponseSingle_Errors struct {
	Code    any
	Message any
	Source  any
}

type RegistrarApiWorkflowStatusResponseSingle_Result_Error struct {
	Code    any
	Message any
}

type RegistrarApiWorkflowStatusResponseSingle_Result_Links struct {
...
type RegistrarApiWorkflowStatusResponseSingle_Result struct {
