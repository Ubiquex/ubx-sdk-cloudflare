...
package radarlayer7attacks

import ubx "github.com/ubiquex/ubx-sdk-go/runtime"

type MitigationProduct_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource any
	Description any
	EndDate any
	EventType any
...
type MitigationProduct_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type MitigationProduct_Result_Meta_DateRange struct {
	EndTime any
	StartTime any
}

type MitigationProduct_Result_Meta_Units struct {
	Name any
	Value any
}

type MitigationProduct_Result_Meta struct {
	ConfidenceInfo any
	DateRange any
...
type MitigationProduct_Result struct {
	// Metadata for the results.
	Meta any
	Summary0 any
}

type MitigationProductConfig struct {
...
type MitigationProductAttrs struct {
	// Filters results by Autonomous System. Specify one or more Autonomous System Numbers (ASNs) as a comma-separated list. Prefix with `-` to exclude ASNs from results. For example, `-174, 3356` excludes results from AS174, but includes results from AS3356.
	Asn any
	// Filters results by continent. Specify a comma-separated list of alpha-2 codes. Prefix with `-` to exclude continents from results. For example, `-EU,NA` excludes results from EU, but includes results from NA.
	Continent any
...
var MitigationProduct = ubx.DataSourceBinding{
