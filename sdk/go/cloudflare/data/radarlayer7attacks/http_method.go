...
type HttpMethod_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type HttpMethod_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type HttpMethod_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type HttpMethod_Result_Meta_Units struct {
	Name  any
	Value any
}

type HttpMethod_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
var HttpMethod = ubx.DataSourceBinding{
