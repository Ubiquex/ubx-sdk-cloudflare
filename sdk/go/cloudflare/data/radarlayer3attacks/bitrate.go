...
type Bitrate_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type Bitrate_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type Bitrate_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type Bitrate_Result_Meta_Units struct {
	Name  any
	Value any
}

type Bitrate_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
type Bitrate_Result_Summary0 struct {
	// A numeric string.
	Over100Gbps any
	// A numeric string.
	Under500Mbps any
...
var Bitrate = ubx.DataSourceBinding{
