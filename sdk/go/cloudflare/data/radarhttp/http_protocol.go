...
type HttpProtocol_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource      any
	Description     any
	EndDate         any
	EventType       any
...
type HttpProtocol_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type HttpProtocol_Result_Meta_DateRange struct {
	EndTime   any
	StartTime any
}

type HttpProtocol_Result_Meta_Units struct {
	Name  any
	Value any
}

type HttpProtocol_Result_Meta struct {
	ConfidenceInfo any
	DateRange      any
...
type HttpProtocol_Result_Summary0 struct {
	// A numeric string.
	Http any
	// A numeric string.
	Https any
...
type HttpProtocol_Result struct {
...
var HttpProtocol = ubx.DataSourceBinding{
