...
type BotClas_Result_Meta_ConfidenceInfo_Annotations struct {
	DataSource any
	Description any
	EndDate any
	EventType any
...
type BotClas_Result_Meta_ConfidenceInfo struct {
	Annotations any
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level any
}

type BotClas_Result_Meta_DateRange struct {
	EndTime any
	StartTime any
}

type BotClas_Result_Meta_Units struct {
	Name any
	Value any
}

type BotClas_Result_Meta struct {
	ConfidenceInfo any
	DateRange any
...
type BotClas_Result_Summary0 struct {
	// A numeric string.
	Bot any
	// A numeric string.
	Human any
...
type BotClas_Result struct {
	// Metadata for the results.
	Meta any
	Summary0 any
}

type BotClasConfig struct {
...
var BotClas = ubx.DataSourceBinding{
